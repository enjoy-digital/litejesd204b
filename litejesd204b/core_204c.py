...
# SYNC~/CGS/ILAS: lane alignment comes from sync header lock (BlockSync) and extended multiblock
# lock, with deterministic latency from the LEMC counter (the LMFC counter at lemc_cycles).
